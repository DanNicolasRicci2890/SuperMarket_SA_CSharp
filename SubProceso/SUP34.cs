...
namespace SuperMarket_SA
{
    public class SUP34
    {
        public static void Mensage02(ref BDState dt)
        {
            ...
            Console.Clear();
            string[] mensaje = { "   S T O C K   D E   S U C U R S A L   ", "   E L I M I N A D O   " };
        ...
        public static void RemoveStock(ref BDState dt)
        {
            ...
            dt.SetMState(TypeState._DepotLogicRemoveST, DepotLogicRemoveST._MENSAGE02);
        }
        public static void DespositoRemove(ref BDState dt)
        {
            ...
            IOdata.Selector(color.BLANCO, color.AZUL, " ¿ Desea Eliminar el Stock Seleccionado ? ", 44, 64, 8);
            ...
            IOBUTTON btn_SELECCIONAR_ = new IOBUTTON("   ELIMINAR   ", backcorral, forecorral, backtitulo2, foretitulo2, TypeLine._DOUBLE, 20, 33);
            ...
            OUT.PrintLine(dt.STOCKPRO.StockGondola.ToString(), color.ROJO, color.NEGRO, 40, 26);
            ...
            while (estado)
            {
                ...
                {
                    dt.SetMState(TypeState._DepotLogicRemoveST, DepotLogicRemoveST._REMOVE);
                    estado = false;
                }
                if ((bool)(btn_VOLVER_.GetDataInfo()))
                {
                    dt.SetMState(TypeState._DepotLogicRemoveST, DepotLogicRemoveST._LISTER_PRODUCTO);
                    estado = false;
                }
                if (!script)
                {
        ...
        public static void SeccionProducto(ref BDState dt)
        {
            ...
            string titulo = " Deposito y Logistica - Lista de Remove - ";
            string tecla = "";
            ...
            while (estado)
            {
                ...
                if ((bool)(btn_SELECCIONAR_.GetDataInfo()))
                {
                    ...
                    dt.SetMState(TypeState._DepotLogicRemoveST, DepotLogicRemoveST._SELECT_PRODUCTO);
                    estado = false;
                }
                if (!script)
                {
        ...
        public static void VerifSucursal(ref BDState dt)
        {
            ...
            if (count > 0) { dt.SetMState(TypeState._DepotLogicRemoveST, DepotLogicRemoveST._LISTER_PRODUCTO); }
            if (count == 0) { dt.SetMState(TypeState._DepotLogicRemoveST, DepotLogicRemoveST._MENSAGE01); }
        }
        ...
        {
            dt.SetMState(TypeState._DepotLogicRemoveST, DepotLogicRemoveST._none);
            dt.SetMState(TypeState._LiveDepotLogicRemoveST, LiveProgram._INACTIVATED);
        ...
        public static void SeccionSucursal(ref BDState dt)
        {
            ...
            OUT.PrintLine(dt.USERSESION.IdentidadConcatenar(), color.DARK_AZUL, color.BLANCO, 179, 6);
            OUT.PrintLine("legajo: " + dt.USERSESION.Legajo, color.DARK_AZUL, color.BLANCO, 179, 7);
            IOdata.Selector(color.BLANCO, color.AZUL, " Deposito y Logistica - Remove - Listado de Sucursales  ", 59, 74, 8);
            ...
            while (estado)
            {
                ...
                if (!(tecla.Equals("")))
                {
                    ...
                    else
                    {
                        ...
                        {
                            estado = false;
                            dt.SetMState(TypeState._DepotLogicRemoveST, DepotLogicRemoveST._VOLVER);
                        }
                        else
                        {
                            if (tecla.Equals("ENTER"))
                            {
                                ...
                                dt.SetMState(TypeState._DepotLogicRemoveST, DepotLogicRemoveST._VERIF_PRODUCTO);
                                estado = false;
                            }
                        }
                    }
