...
namespace SuperMarket_SA
{
    public class SUP15
    {
        public static void MensageP11(ref BDState dt)
        {
            COLOR.ColorFondo(color.NEGRO);
            Console.Clear();
            string[] mensaje = { "   L O S   D A T O S   ",
                                 "   D E   L A   N U E V A   ",
                                 "   S U C U R S A L   H A N   ",
                                 "   S I D O   G U A R D A D A   ",
                                 "   E N   L A   B A S E   ",
                                 "   D  E   D  A  T  O  S   " };
        ...
        public static void CrearSucursal(ref BDState dt)
        {
            ...
            dt.SetMState(TypeState._SucursAddST, SucursalesAddST._MENSAGE11);
        }
        public static void GuardarSucursal(ref BDState dt)
        {
            ...
            // Ingresar la sucursal a la lista
            sucursal.AgregarSucursal(dt.SUCURSALCREATE);

            // Ordenar la lista de sucursales
            sucursal.OrdenamientoSucursal();

            // Guardar los datos de la lista al archivo.
            sucursal.SaveFileSucursales();

            dt.SetMState(TypeState._SucursAddST, SucursalesAddST._CREATE_SUCURSAL);
        }
        public static void MensageP10(ref BDState dt)
        {
            COLOR.ColorFondo(color.NEGRO);
            Console.Clear();
            ...
            mensaje[0] = "   E L   C O D I G O    D E   L A    ";
            mensaje[1] = "   S U C U R S A L    I N G R E S A D O   ";
        ...
        public static void VerificarCodigo(ref BDState dt)
        {
            FDSucursal sucursal = new FDSucursal("ListSucursales");
            sucursal.LoadFileSucursales();
            int index = sucursal.SeekCodSucursal(dt.SUCURSALCREATE.CODIGO);
            if (index == -1) { dt.SetMState(TypeState._SucursAddST, SucursalesAddST._SAVE_SUCURSAL); }
            if (index != -1) { dt.SetMState(TypeState._SucursAddST, SucursalesAddST._MENSAGE10); }
        }
        public static void MensageP9(ref BDState dt)
        {
            ...
            Console.Clear();
            mensaje = new string[4];
            mensaje[0] = "   E L   N O M B R E    D E   L A    ";
            mensaje[1] = "   S U C U R S A L    I N G R E S A D O   ";
            mensaje[2] = "   S E    E N C U E N T R A   ";
            mensaje[3] = "   E X I S T E N T E   ";
            FUNCTION.Mensagedata(mensaje, color.AMARILLO, color.ROJO, color.ROJO, 100, 20);
            ...
            mensaje[0] = "   I N G R E S E   ";
            mensaje[1] = "   O T R O   ";
            mensaje[2] = "   N O M B R E   ";
            FUNCTION.Mensagedata(mensaje, color.AMARILLO, color.ROJO, color.ROJO, 100, 20);
            dt.SetMState(TypeState._SucursAddST, SucursalesAddST._ADD);
        }
        public static void VerificarNombreSucursal(ref BDState dt)
        {
            FDSucursal sucursal = new FDSucursal("ListSucursales");
            sucursal.LoadFileSucursales();
            int index = sucursal.SeekNomSucursal(dt.SUCURSALCREATE.NOMSUCURSAL);
            if (index == -1) { dt.SetMState(TypeState._SucursAddST, SucursalesAddST._VERIF_CODE); }
            if (index != -1) { dt.SetMState(TypeState._SucursAddST, SucursalesAddST._MENSAGE09); }
        }
        ...
        {
            dt.SetMState(TypeState._SucursAddST, SucursalesAddST._MENSAGE01);
            if (!(dt.SUCURSALCREATE.NOMSUCURSAL.Equals("")))
            {
                dt.SetMState(TypeState._SucursAddST, SucursalesAddST._MENSAGE02);
                if (!(dt.SUCURSALCREATE.CODIGO.Equals(""))) 
                {
                    dt.SetMState(TypeState._SucursAddST, SucursalesAddST._MENSAGE03);
                    if (!(dt.SUCURSALCREATE.DIRECCION.Equals("")))
                    {
                        dt.SetMState(TypeState._SucursAddST, SucursalesAddST._MENSAGE04);
                        if (!(dt.SUCURSALCREATE.NUMERO.Equals("")))
                        {
                            dt.SetMState(TypeState._SucursAddST, SucursalesAddST._MENSAGE05);
                            if (!(dt.SUCURSALCREATE.CODPOST.Equals("")))
                            {
                                dt.SetMState(TypeState._SucursAddST, SucursalesAddST._MENSAGE06);
                                if (!(dt.SUCURSALCREATE.PROVINCIA.Equals("")))
                                {
                                    dt.SetMState(TypeState._SucursAddST, SucursalesAddST._MENSAGE07);
                                    if (!(dt.SUCURSALCREATE.LOCALIDAD.Equals("")))
                                    {
                                        dt.SetMState(TypeState._SucursAddST, SucursalesAddST._MENSAGE08);
                                        if (!(dt.SUCURSALCREATE.PAIS.Equals("")))
                                        {
                                            dt.SetMState(TypeState._SucursAddST, SucursalesAddST._VERIF_NOMB);
                                        }
                                    }
                                }
        ...
        {
            dt.SetMState(TypeState._SucursAddST, SucursalesAddST._none);
            dt.SetMState(TypeState._LiveSucursAddST, LiveProgram._INACTIVATED);
        ...
        public static void IngresodeSucursales(ref BDState dt)
        {
            bool estado = true;
            bool script = false;
            int contador = 0;   
            string deg = "Administracion - SUCURSALES - Ingreso de Sucursales ";
            IN key_data = new IN();
            ...
            IOBUTTON btn_ACEPTAR_ = new IOBUTTON("   GUARDAR   ", backcorral, forecorral, backtitulo2, foretitulo2, TypeLine._DOUBLE, 71, 30);
            ...
            NombreSucursal_.SetTypeDataIN(TypeDataIN._LETTER);
            NombreSucursal_.SetTypeDataIN(TypeDataIN._SHIFT_LETTER);
            NombreSucursal_.SetTypeDataIN(TypeDataIN._NUMERIC_FILE);
            NombreSucursal_.SetTypeDataIN(TypeDataIN._SHIFT_CARACTER_SPECIAL);
            ...
            while (estado)
            {
                ...
                if (!script)
                {
                    switch (contador)
                    {
                        case 0: NombreSucursal_.SetSemiInactivated(); break;
                        case 1: Codigo_.SetSemiInactivated(); break;
                        case 2: Direccion_.SetSemiInactivated(); break;
                        case 3: Nro_.SetSemiInactivated(); break;
                        case 4: CodPost_.SetSemiInactivated(); break;
                        case 5: Provincia_.SetSemiInactivated(); break;
                        case 6: Localidad_.SetSemiInactivated(); break;
                        case 7: Pais_.SetSemiInactivated(); break;
                ...
                if (script)
                {
                    switch (contador)
                    {
                        case 0: NombreSucursal_.SetActivated(); break;
                        case 1: Codigo_.SetActivated(); break;
                        case 2: Direccion_.SetActivated(); break;
                        case 3: Nro_.SetActivated(); break;
                        case 4: CodPost_.SetActivated(); break;
                        case 5: Provincia_.SetActivated(); break;
                        case 6: Localidad_.SetActivated(); break;
                        case 7: Pais_.SetActivated(); break;
                ...
                for(int i = 0; i < 10; i++)
                {
                    if (i != contador)
                    {
                        switch (i)
                        {
                            case 0: NombreSucursal_.Display(color.NEGRO, color.NEGRO); break;
                            case 1: Codigo_.Display(color.NEGRO, color.NEGRO); break;
                            case 2: Direccion_.Display(color.NEGRO, color.NEGRO); break;
                            case 3: Nro_.Display(color.NEGRO, color.NEGRO); break;
                            case 4: CodPost_.Display(color.NEGRO, color.NEGRO); break;
                            case 5: Provincia_.Display(color.NEGRO, color.NEGRO); break;
                            case 6: Localidad_.Display(color.NEGRO, color.NEGRO); break;
                            case 7: Pais_.Display(color.NEGRO, color.NEGRO); break;
                ...
                {
                    dt.SUCURSALCREATE.NOMSUCURSAL = NombreSucursal_.GetDataInfo().ToString();
                    dt.SUCURSALCREATE.CODIGO = Codigo_.GetDataInfo().ToString();
                    ...
                    estado = false;
                    script = true;
                    dt.SetMState(TypeState._SucursAddST, SucursalesAddST._VERIF_DATOS);
                }
                if ((bool)btn_ESCAPE_.GetDataInfo())
                {
                    estado = false;
                    script = true;
                    dt.SetMState(TypeState._SucursAddST, SucursalesAddST._VOLVER);
                }
                if (!script)
                {
